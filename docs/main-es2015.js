...
const routes = [
    ...
    {
        path: 'story',
        loadChildren: () => Promise.all(/*! import() | story-story-module */[__webpack_require__.e("common"), __webpack_require__.e("story-story-module")]).then(__webpack_require__.bind(null, /*! ./story/story.module */ "./src/app/story/story.module.ts")).then(m => m.StoryPageModule)
    },
];
...
module.exports = __webpack_require__(/*! /Users/yuriylebid/projects/storyteller/src/main.ts */"./src/main.ts");
